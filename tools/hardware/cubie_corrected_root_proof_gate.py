...
CHECKS: list[tuple[str, str, str]] = [
    ...
    ("gic_cpu0", "GICv3 redistributor for CPU0", r"GICv3:.*CPU0.*redistributor|CPU0:.*redistributor"),
    ("gic_cpu1", "GICv3 redistributor for CPU1", r"GICv3:.*CPU1.*redistributor|CPU1:.*redistributor"),
    ("gic_cpu2", "GICv3 redistributor for CPU2", r"GICv3:.*CPU2.*redistributor|CPU2:.*redistributor"),
    ("gic_cpu3", "GICv3 redistributor for CPU3", r"GICv3:.*CPU3.*redistributor|CPU3:.*redistributor"),
    ("gic_cpu4", "GICv3 redistributor for CPU4", r"GICv3:.*CPU4.*redistributor|CPU4:.*redistributor"),
    ("gic_cpu5", "GICv3 redistributor for CPU5", r"GICv3:.*CPU5.*redistributor|CPU5:.*redistributor"),
    ("gic_cpu6", "GICv3 redistributor for CPU6", r"GICv3:.*CPU6.*redistributor|CPU6:.*redistributor"),
    ("gic_cpu7", "GICv3 redistributor for CPU7", r"GICv3:.*CPU7.*redistributor|CPU7:.*redistributor"),
