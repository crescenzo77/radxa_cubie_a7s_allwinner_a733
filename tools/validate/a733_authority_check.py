...
def check_local_pending_prep_checkpoint(root: Path, failures: list[str]) -> None:
    ...
    required = [
        ...
        "8f94b8d2c4cf6a5e664c95521e340f301789a499",
        ...
        "A733-CYCLE-033",
        "Substantive prep cycle-ledger records through A733-CYCLE-059",
        "A733-CYCLE-059",
        "Checkpoint-only refresh cycles after A733-CYCLE-059",
